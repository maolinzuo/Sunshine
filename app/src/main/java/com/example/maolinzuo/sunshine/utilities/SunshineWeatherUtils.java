...
public class SunshineWeatherUtils {
    ...
    public static String formatTemperature(Context context, double temp){
        ...
        int temperatureFromatResourceId = R.string.format_temperature;
        return String.format(context.getString(temperatureFromatResourceId), temp);
    }

    public static double celsiusToFahrenheit(double temp){
        double tempInFa = (temp * 1.8) + 32;
        return tempInFa;
    }

    public static int getSmallArtResourceIdForWeatherConditon(int weatherId){
        if (weatherId >= 200 && weatherId <= 232) {
    ...
    public static int getLargeArtResourceIdForWeatherCondtion(int weatherId){
        if (weatherId >= 200 && weatherId <= 232) {
