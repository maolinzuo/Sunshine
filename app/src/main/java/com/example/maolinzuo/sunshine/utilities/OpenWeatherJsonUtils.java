...
public class OpenWeatherJsonUtils {
    ...
    public static ContentValues[] getWeatherContentValuesFromJson(Context context, String jsonString)
    throws JSONException{
        ...
        long normalizedUtiStartDay = SunshineDateUtils.getNormalizedUtcDateForToday();
        ...
        for(int i=0; i < jsonWeatherArray.length(); i++){
            ...
            dateTimeMillis = normalizedUtiStartDay + SunshineDateUtils.DAY_IN_MILLIS *i;
