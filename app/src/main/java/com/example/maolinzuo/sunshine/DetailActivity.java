...
import com.example.maolinzuo.sunshine.databinding.ActivityDetailBinding;
...
public class DetailActivity extends AppCompatActivity
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        int weatherImageId = SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondtion(weatherId);
        ...
        String descriptionA11l = getString(R.string.a11y_forecast, description);

        mDetailBinding.primaryInfo.weatherDescription.setText(description);
        mDetailBinding.primaryInfo.weatherDescription.setContentDescription(descriptionA11l);
        ...
        mDetailBinding.primaryInfo.lowTemperature.setText(lowA11y);
